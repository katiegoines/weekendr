                ...
                {!!this.state.tileView
                    ? <span className="search-results">
                        {!this.state.error
                            ? <span>
                                {this.state.results.head !== ''
                                    ? <div className="search-category">
                                        ...
                                        <a href={`https://www.yelp.com/search?categories=cocktailbars&location=${this.props.search}&start=0&cflt=cocktailbars`} target="_blank">See more results from Yelp</a>
                                    </div>
                                    : null
                                }
                            ...
                            : <span>
                                <div className="search-category">
                                    <h3>Cocktail Bars <br /> Coming Soon</h3>
                                </div>
                            </span>
                        }                
                    </span>
