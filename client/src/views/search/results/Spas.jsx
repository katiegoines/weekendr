...
class Spas extends React.Component {
    constructor(props) {
        super(props)
    ...
    request() {
        axios({method: 'get', url: `/api/search/yelp?categories=spas&location=${this.props.search}`})
        .then((res) => { 
                            ...
                            ? <span>
                                {this.state.results.head !== ''
                                    ? <div className="search-category">
                                        ...
                                        <a href={`https://www.yelp.com/search?categories=spas&location=${this.props.search}&start=0&cflt=spas`} target="_blank">See more results from Yelp</a>
                                    </div>
                                    : null
                                }
