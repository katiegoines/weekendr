...
class SportingGoods extends React.Component {
    ...
    request() {
        axios({method: 'get', url: `/api/search/yelp?categories=sportgoods&location=${this.props.search}`})
        .then((res) => { 
                ...
                {!!this.state.tileView
                    ? <span className="search-results">
                        {!this.state.error
                            ? <span>
                                {this.state.results.head !== ''
                                    ? <div className="search-category">
                                        ...
                                        <a href={`https://www.yelp.com/search?categories=sportgoods&location=${this.props.search}&start=0&cflt=sportgoods`} target="_blank">See more results from Yelp</a>
                                    </div>
                                    : null
                                }
                            ...
                            : <span>
                                <div className="search-category">
                                    <h3>Sporting Goods <br /> Coming Soon</h3>
                                </div>
                            </span>
                        }                
                    </span>
