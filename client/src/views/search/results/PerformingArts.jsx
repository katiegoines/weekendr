...
class PerformingArts extends React.Component {
    constructor(props) {
        super(props)
    ...
    request() {
        ...
        axios({method: 'get', url: `/api/search/eventful?location=${this.props.search}&category=performing_arts&dateRange=${dates}`})
        .then((res) => { 
                ...
                {!!this.state.tileView
                    ? <span className="search-results">
                        {!this.state.error
                            ...
                            : <span>
                                <div className="search-category">
                                    <h3>Performing Arts<br /> Coming Soon</h3>
                                </div>
                            </span>
                        }
                    </span>
