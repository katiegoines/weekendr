...
class Zoos extends React.Component {
    ...
    request() {
        axios({method: 'get', url: `/api/search/yelp?categories=zoos,aquariums&location=${this.props.search}`})
        .then((res) => { 
                            ...
                            ? <span>
                                {this.state.results.head !== ''
                                    ? <div className="search-category">
                                        ...
                                        <a href={`https://www.yelp.com/search?categories=zoos,aquariums&location=${this.props.search}&start=0&cflt=zoos,aquariums`} target="_blank">See more results from Yelp</a>
                                    </div>
                                    : null
                                }
