...
class Hiking extends React.Component {
    ...
    request() {
        axios({method: 'get', url: `/api/search/yelp?categories=hiking&location=${this.props.search}`})
        .then((res) => { 
                            ...
                            ? <span>
                                {this.state.results.head !== ''
                                    ? <div className="search-category">
                                        ...
                                        <a href={`https://www.yelp.com/search?categories=hiking&location=${this.props.search}&start=0&cflt=hiking`} target="_blank">See more results from Yelp</a>
                                    </div>
                                    : null
                                }
