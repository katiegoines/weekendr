...
class Pubs extends React.Component {
    ...
    request() {
        axios({method: 'get', url: `/api/search/yelp?categories=pubs&location=${this.props.search}`})
        .then((res) => { 
                            ...
                            ? <span>
                                {this.state.results.head !== ''
                                    ? <div className="search-category">
                                        ...
                                        <a href={`https://www.yelp.com/search?categories=pubs&location=${this.props.search}&start=0&cflt=pubs`} target="_blank">See more results from Yelp</a>
                                    </div>
                                    : null
                                }
