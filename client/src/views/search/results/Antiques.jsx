...
class Antiques extends React.Component {
    constructor(props) {
        super(props)
                            ...
                            ? <span>
                                {this.state.results.head !== ''
                                    ? <div className="search-category">
                                        ...
                                        <a href={`https://www.yelp.com/search?categories=antiques&location=${this.props.search}&start=0&cflt=antiques`} target="_blank">See more results from Yelp</a>
                                    </div>
                                    : null
                                }
